    ...
    <div className={styles.maincontainer}>
        <div className={styles.white1}>
            <div className={styles.midcontainer1}>
                <div data-aos="fade-right" className={styles.midimg1}>
                    <img src="./who are we 1.png" alt="" />
                </div>
                <div data-aos="fade-left" className={styles.midtext1}>
        ...
        <div className={styles.white}>
             <div className={styles.midcontainer2}>
                <div data-aos="fade-right" className={styles.midtext2}>
                     <h2 className={styles.h2w} >ROLE OF SOCIAL MEDIA</h2>
                     <p className={styles.pw} >Creating and developing a website is important for any business. Along with having a website, 
                ...
                <div data-aos="fade-left" className={styles.midimg2}>
                    <img src="./role of SM 1.png" alt="" />
                </div>
            </div>
        </div>
